...
class Regex:
    ...
    def run_regex_predict(self, query):
        ...
        return s.strip(), number, url, url2, email, datetime, non_vnese, mark, mark3, mark4

    def restore_info(self, q, number, url, url2, email, datetime, non_vnese, mark, mark3, mark4):
    ...
    # def detect_title(self, mask, s, predict_mode=False):
    #     original = s.split(u' ')
    #     new = []
    #     values = []
    #     for w in original:
...
if __name__ == '__main__':
    r = Regex()
    s = u'Mr.Siro'
    ss = r.detect_non_vnese.sub(u'nonvnese', s)
    print ss
